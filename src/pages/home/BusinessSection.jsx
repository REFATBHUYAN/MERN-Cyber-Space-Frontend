      ...
      <Container>
        <div className="flex flex-col md:flex-row gap-28 max-w-6xl mx-auto items-center">
          ...
          <div className="max-w-[580px] space-y-5 text-slate-400">
            ...
            <p>
              CyberSpace Digital is here to help you shape your dream! We are a
              creative agency providing various digital services to renowned
              ...
              <div className="space-y-2">
                <p className="flex items-center gap-2">
                  <svg
                    ...
                    class="icon icon-tabler icon-tabler-circle-check-filled text-slate-400"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                    stroke-width="2"
